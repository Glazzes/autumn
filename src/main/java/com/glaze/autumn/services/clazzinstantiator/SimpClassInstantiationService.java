...
import com.glaze.autumn.services.depedencyresolver.DependencyResolverService;
import com.glaze.autumn.services.missingdepsscanner.MissingDependencyHandler;
import com.glaze.autumn.services.depedencyresolver.SimpDependencyResolverService;
import com.glaze.autumn.services.missingdepsscanner.SimpMissingDependencyHandler;
import com.glaze.autumn.exceptions.DuplicatedIdentifierException;
...
public class SimpClassInstantiationService implements ClassInstantiationService {
    ...
    private String getInstanceId(Class<?> type) {
